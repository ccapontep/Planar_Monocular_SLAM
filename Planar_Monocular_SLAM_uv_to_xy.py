...
def uv_to_xy(t, u, v, meas_land, id_to_state_map, robot_pose_map):
    ...
    gamma, H_C_2, Rq_curr = gamma_calc(u_v2[0,0], u_v2[1,0], Cam_pose_1, Cam_pose_2)
    alpha = alpha_calc(beta, gamma)
    landmark_pos_world, row, h_c_reverse, theta = landmark_pos(beta, alpha, gamma, H_C_2, b, Cam_pose_1, Cam_pose_2, Rq_curr, Rq_1)
    

    return (landmark_pos_world, id_to_state_map, alpha, beta, b, row, h_c_reverse, theta)
